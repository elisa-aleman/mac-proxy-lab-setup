...
Recent versions of MacOS have a dependency error when installing python via pyenv sometimes. Let's install that dependency first.

`brew install xz`

Now let's install and set the latest version as the global python:
